...
function onAssetsLoaded() {
  ...
  const slotTextures = [
    PIXI.Texture.from("../../public/1.png"),
    PIXI.Texture.from("../../public/2.png"),
  ...
  const playText = new PIXI.Text("开始", style);
  ...
  // Add header text
  const headerText = new PIXI.Text("Slot", style);
  ...
  app.ticker.add(() => {
    ...
    for (let i = 0; i < reels.length; i++) {
      ...
      r.blur.blurY = (r.position - r.previousPosition) * 70;
